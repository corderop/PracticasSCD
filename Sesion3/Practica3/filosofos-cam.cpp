...
void funcion_filosofos( int id )
{
  ...
  while ( true )
  {
    ...
    MPI_Ssend( &dato, 1, MPI_INT, id_camarero, etiq_sentarse, MPI_COMM_WORLD);

    cout <<"Filósofo " <<id << " solicita ten. izq." <<id_ten_izq <<endl;
    // ... solicitar tenedor izquierdo (completar)
    MPI_Ssend( &dato, 1, MPI_INT, id_ten_izq, etiq_tenedor, MPI_COMM_WORLD);

    cout <<"Filósofo " <<id <<" solicita ten. der." <<id_ten_der <<endl;
    // ... solicitar tenedor derecho (completar)
    MPI_Ssend( &dato, 1, MPI_INT, id_ten_der, etiq_tenedor, MPI_COMM_WORLD);
    ...
    MPI_Ssend( &dato, 1, MPI_INT, id_camarero, etiq_levantarse, MPI_COMM_WORLD);
...
int main( int argc, char** argv )
{
   ...
   if ( num_procesos == num_procesos_actual )
   {
      ...
      if ( id_propio % 2 == 0 && id_propio != id_camarero)  // si es par y no es camarero

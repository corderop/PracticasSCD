...
// del productor/consumidor, con multiples productores y consumidores.
// Opcion FIFO (stack)
//
// Historial:
...
void ProdCons1SU::escribir( int valor )
{
   ...
   while ( num_celdas_ocupadas == 10 )
      libres.wait();

   //cout << "escribir: ocup == " << num_celdas_ocupadas << ", total == " << num_celdas_total << endl ;
   assert( num_celdas_ocupadas < 10 );
...
void funcion_hebra_productora( MRef<ProdCons1SU> monitor, int numero_hebra_productora )
{
